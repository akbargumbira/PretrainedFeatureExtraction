...
def train(previous_model=None, lr=0.001, epochs=50):
    ...
    # # Checkpoint
    filepath = 'model/gender/weights-top_model-improvement-{epoch:02d}-{' \
               'val_acc:.2f}.hdf5'
...
# train(
#     previous_model='model/gender/top_model_1/weights-top_model_last.hdf5',
#     lr=1e-4
# )
